...
public class WheelView extends View {
	...
	private static int VALUE_TEXT_COLOR = 0xF0313233;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xF0b5babc;

	/** Additional items height (is added to standard text item height) */
	private  int ADDITIONAL_ITEM_HEIGHT = 10;

	/** Text size */
	public int TEXT_SIZE = 25;

	private int VALUE_TEXT_SIZE = 30;
	...
	private void initData(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.wheel_atter);
			TEXT_SIZE = array.getInteger(R.styleable.wheel_atter_text_size, TEXT_SIZE);
			VALUE_TEXT_SIZE = array.getInteger(R.styleable.wheel_atter_value_text_size, VALUE_TEXT_SIZE);
			VALUE_TEXT_COLOR = array.getInteger(R.styleable.wheel_atter_value_text_color, VALUE_TEXT_COLOR);
			TEXT_SIZE = FunctionUtil.dip2px(context, TEXT_SIZE);
			VALUE_TEXT_SIZE = FunctionUtil.dip2px(context, VALUE_TEXT_SIZE);
			ADDITIONAL_ITEM_HEIGHT = array.getInteger(R.styleable.wheel_atter_item_height, ADDITIONAL_ITEM_HEIGHT);
			ADDITIONAL_ITEMS_SPACE = array.getInteger(R.styleable.wheel_atter_item_space, ADDITIONAL_ITEMS_SPACE);
			array.recycle();
		}
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			// itemsPaint.setTypeface(Typeface.createFromAsset(mContext.getAssets(),"fonts/CG.ttf"));
		}
		...
		if (valuePaint == null) {
			...
			// valuePaint.setTypeface(Typeface.createFromAsset(mContext.getAssets(),"fonts/CG.ttf"));
		}
